...
<script src="resources/js/ajax/ajax_map_land_price_area.js"></script>
<section class="tbdetailf">
    ...
    <div class="tbdf-wp">
        ...
        <div class="tbbwp" id="tableInfoSoild">
            <div class="tableBangGiaDat12-13-14">
                <%--                <div class="table-wp">--%>
        ...
        <div class="block-right-qh">
            <div class="block-search-qh-bd">
                ...
                <select name="" id="tieuChiSearchMap">
                    <option value="tenXa">Tên Xã/ Phường/ Thị Trấn</option>
            ...
            <div class="block-hienthi" style="width: 215px; right: 5px;">
                <ul>
                    <li>
                        <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Chú thích màu
